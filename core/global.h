...
const quint64 NANO_MWC = 1000000000;
const quint64 BASE_TRANSACTION_FEE = 1000000/1000;   // Jul 20 2025, one micro-mwc.  Changed form 1 mili

const quint64 MWC_MAX_OUTPUTS = 500;
