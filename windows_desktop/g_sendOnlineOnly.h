...
#ifndef SEND2_ONLINE_ONLY_H
#define SEND2_ONLINE_ONLY_H

#include "../core_desktop/navwnd.h"

namespace Ui {
class SendOnlineOnly;
}
...
class SendOnlineOnly : public core::NavWnd
{
    Q_OBJECT

public:
    explicit SendOnlineOnly(QWidget *parent );
    virtual ~SendOnlineOnly() override;
