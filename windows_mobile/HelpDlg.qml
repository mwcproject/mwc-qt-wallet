...
Item {
    ...
    function open(docName, htmlText) {
        text_content.text = htmlText;
        switch (docName) {
        case 'accounts.html':
    ...
    onVisibleChanged: {
        if (visible) {
            view_content.contentItem.contentY = 0
        }
    }
    ...
    Rectangle {
        ...
        ScrollView {
            ...
            contentHeight: text_content.height
